...
const SideBar: React.FC = () => {
    ...
    return (
        <motion.div variants={variants} initial='hidden' animate='visible' transition={{ duration: .5 }} className={styles.sidebar}>
            <a className={styles.sidebar__item} href={ProfileInfo.github} target="_blank" rel="noreferrer">
                <Image src={GithubIcon} width={48} height={48} alt='github' />
            </a>
            <a className={styles.sidebar__item} href={ProfileInfo.linkedin} target="_blank" rel="noreferrer">
                <Image src={LinkedinIcon} width={48} height={48} alt='linkedin' />
            </a>
            <a className={styles.sidebar__item} href={ProfileInfo.twitter} target="_blank" rel="noreferrer">
                <Image src={TwitterIcon} width={48} height={48} alt='twitter' />
            </a>
            <a className={styles.sidebar__item} href={ProfileInfo.instagram} target="_blank" rel="noreferrer">
